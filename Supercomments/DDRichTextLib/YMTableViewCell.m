...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _headerImage = [[UIImageView alloc] initWithFrame:CGRectMake(14, 16, 35, 35)];
        _headerImage.backgroundColor = [UIColor clearColor];
		_headerImage.userInteractionEnabled = YES;
        _headerImage.layer.masksToBounds = YES;
        _headerImage.layer.cornerRadius = 35/2;
		...
		_nameLbl = [[UILabel alloc] initWithFrame:CGRectMake(14 + 35 + 16, 16, screenWidth - 120, 15)];
        ...
        _introLbl = [[UILabel alloc] initWithFrame:CGRectMake(14 + 35 + 16, 16+6+14 , screenWidth - 120, 12)];
        _introLbl.numberOfLines = 1;
        _introLbl.font = [UIFont systemFontOfSize:11.0];
        _introLbl.textColor = [UIColor wjColorFloat:@"C7C7CD"];
...
- (void)setYMViewWith:(YMTextData *)ymData{
    ...
    WFTextView *textView = [[WFTextView alloc] initWithFrame:CGRectMake(64, 15 + TableHeader, screenWidth - 64-14, 0)];
    ...
    textView.frame = CGRectMake(64, 15 + TableHeader, screenWidth - 64-14, hhhh);
...
//        image.image = [UIImage imageNamed:[NSString stringWithFormat:@"%@",[ymData.showImageArray objectAtIndex:i]]];
    ...
    if (_hideReply) {
        ...
        for (int i = 0; i < ymData.replyDataSource.count; i ++ ) {
            ...
            WFTextView *_ilcoreText = [[WFTextView alloc] initWithFrame:CGRectMake(64,TableHeader + 10 + ShowImage_H + (ShowImage_H + 10)*(scale_Y/3) + origin_Y + hhhh + kDistance + (ymData.islessLimit?0:30) + balanceHeight , screenWidth -  64-14, 0)];
            ...
            _ilcoreText.frame = CGRectMake(64,TableHeader + 10 + ShowImage_H + (ShowImage_H + 10)*(scale_Y/3) + origin_Y + hhhh + kDistance + (ymData.islessLimit?0:30) + balanceHeight , screenWidth -  64-14, [_ilcoreText getTextHeight]);
        ...
        if (ymData.replyDataSource.count == 0) {//没回复的时候
            ...
            _replyImageView.frame = CGRectMake(64, backView_Y - 10 + balanceHeight + 5 , 0, 0);

            
        }else{
            
            _replyImageView.frame = CGRectMake(64, backView_Y - 10 + balanceHeight + 5 , screenWidth - 64-14, backView_H + 20 - 12);//微调
        }
    }
}
